    ...
    async def get_negotiation_summary(transcript: list, topic: str) -> str:
        ...
        try:
            genai.configure(api_key=API_KEY_1) # Ensure correct key is set
    ...
    async def start_negotiation_endpoint(request: NegotiationRequest):
        ...
        try:
            model1 = genai.GenerativeModel(model_name=request.character1.model_name, system_instruction=instruction1)
            model2 = genai.GenerativeModel(model_name=request.character2.model_name, system_instruction=instruction2)
        ...
        transcript = negotiation_engine.run_negotiation(
            model1_session=chat1, model2_session=chat2,
            ...
            initial_prompt=initial_prompt, duration_seconds=request.duration_seconds,
